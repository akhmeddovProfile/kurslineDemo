...
class MainListProductAdapter(private val  items:List<Product>):RecyclerView.Adapter<MainListProductAdapter.ProductRowHolder>() {
    ...
    val productDescription:TextView=itemView.findViewById(R.id.productDescriptionIntheMainScreen)
    }
